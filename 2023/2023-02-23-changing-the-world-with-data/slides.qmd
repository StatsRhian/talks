...
::: {.column width="40%"}
![](graphics/Clarissa.png){fig-alt="A cartoon of Clarissa"
...
location_icons = iconList(
  Windsor = makeIcon("graphics/describe-clarissa/graphics/windsor.jpg", "graphics/describe-clarissa/graphics/windsor@2x.jpg", 40, 40),
  Nottingham = makeIcon("graphics/describe-clarissa/graphics/nottingham.jpg", "graphics/describe-clarissa/graphics/nottingham@2x.jpg", 40, 40),
  Aberystwyth = makeIcon("graphics/describe-clarissa/graphics/aberystwyth.jpg", "graphics/describe-clarissa/graphics/aberystwyth@2x.jpg", 40, 40),
  Bristol = makeIcon("graphics/describe-clarissa/graphics/bristol.jpg", "graphics/describe-clarissa/graphics/bristol@2x.jpg", 40, 40),
  Newcastle = makeIcon("graphics/describe-clarissa/graphics/newcastle.jpg", "graphics/describe-clarissa/graphics/newcastle@2x.jpg", 40, 40),
  Innsbruck = makeIcon("graphics/describe-clarissa/graphics/innsbruck.jpg", "graphics/describe-clarissa/graphics/innsbruck@2x.jpg", 40, 40)
)
...
::: {.column width="60%"}
![](graphics/Rhian.jpg){fig-alt="A cartoon of Rhian"}
:::
:::

## Rhian

![](graphics/rhian-activity.png){fig-alt="An infographic showing various statistics about 2022 activity"
fig-align="center"}
...
::: {.column width="40%"}
![](graphics/clipboard-robot-transparent.png){fig-alt="A cartoon of a robot with a clipboard."}
:::
:::
...
![](graphics/computer-small-transparent.png){fig-alt="A cartoon of a robot with a clipboard."
fig-align="center"}

## 🦄 What is a data scientist?

![](graphics/faces.png){fig-alt="A collection of cartoons of Jumping Rivers employees. Top: Clarissa, Myles, Keith, Russ. Bottom: Nicola, Jack, Rhian, Mandy"
...
::: columns
::: {.column width="50%"}
![](graphics/fast_food_wordcloud.png){fig-alt="Wordcloud of common words in fast food answers. Mcdonalds, Subway, Greggs and KFC are largest."}
:::

::: {.column width="50%"}
![](graphics/snack_wordcloud.png){fig-alt="Wordcloud of common words in snack answers. Crisps and chocolate are largest."}
:::
:::
...
![](graphics/fast_food_types.png){width="75%" fig-align="center"}

## 👀 Examples

![](graphics/snack_type.png){width="75%" fig-align="center"}

## 👀 Examples

![](graphics/sweetvsavoury.png){width="75%" fig-align="center"}
...
![](graphics/left-join.gif){fig-align="center"}

## 🧲 Full Join

![](graphics/full-join.gif){fig-align="center"}

## 🧲 Inner Join

![](graphics/inner-join.gif){fig-align="center"}
...
![](graphics/tube_map.png){fig-alt="Map of the London underground"
fig-align="center"}

## 👀 Viz examples

![](graphics/football-viz.png){fig-alt="Football match with pundits commentary highlighted."
fig-align="center"}

## 👀 Viz examples

![](graphics/stock-market-crash.png){fig-alt="Plot of 20 and 40 year cycles in the stock market pointing to a low in 2022."
fig-align="center"}

## 👀 Viz examples

![](graphics/network-graph-star-wars-characters.jpg){fig-alt="Plot of many coloured lined interacting on a black background. There are no axes and there is no text."
fig-align="center"}

## 🐧 Meet your clients

![](graphics/climate-scientists.png){fig-alt="Poorly edited image of Rhian and Clarissa cartoons with bobble hats on, in front of an icy mountain, with three cartoon penguins between them."
fig-align="center"}
...
::: {.column width="60%"}
![](graphics/acne.jpg){fig-alt="A cartoon of a woman with acne. The
...
![](graphics/bob-ross-libby.png){fig-align="center"}

## 🎨 Bob Ross - Jared Wilber

![](graphics/bob-ross-jared.png){fig-align="center"}

## 🎨 Bob Ross - Ryan Hart

![](graphics/bob-ross-ryan.png){fig-align="center"}

## 🎨 Bob Ross - Nicola Rennie

![](graphics/bob-ross-nicola.png){fig-align="center"}
