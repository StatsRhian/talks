...
```{}
rhian@xps13:~/git/jr-packages/jrIntroduction$ git commit -m "Test inteRgrate
WARNING: ignoring environment value of R_HOME
◉ Checking file extensions...check_r_filenames()
✔ Extensions look good
✔ Filenames look good
ℹ Checking  R/get_data.R
/home/rhian/git/jr-packages/jrIntroduction/R/get_data.R:54:4: style: Put spaces around all infix operators.
  e=new.env()
  ~^~
